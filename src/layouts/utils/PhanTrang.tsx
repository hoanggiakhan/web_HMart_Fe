        ...
        <nav aria-label="...">
            <ul className="pagination">
                <li className="page-item" onClick={()=>props.phanTrang(1)}>
                    <button className="page-link boder-dark text-dark" >
                        Trang Đầu
                    </button>
                </li>
                {
                    danhSachTrang.map(trang => (
                        <li className="page-item boder-dark text-dark" key={trang} onClick={()=>props.phanTrang(trang)}>
                            <button className={"page-link boder-dark text-dark" + (props.trangHienTai===trang?"active":"")}>
                                {trang}
                            </button>
                        </li>
                    ))
